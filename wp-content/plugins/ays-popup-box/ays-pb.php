 ...
 */
define( 'AYS_PB_NAME_VERSION', '6.1.0' );
            ...
            <div class="navigation-bar">
                <div id="navigation-container">
                    <div class="logo-container">
                        <a href="https://popup-plugin.com/" class="popup-box-logo-link" target="_blank">
                        ...
                        <div>
                            <a href="https://popup-plugin.com/?utm_source=dashboard&utm_medium=popup-free&utm_campaign=popup-top-banner-upgrade-button-<?php echo AYS_PB_NAME_VERSION; ?>" target="_blank" class="popup-box-upgrade-to-pro">
                    ...
                    <ul id="menu">
                        ...
                        <li class="modile-ddmenu-xs ays-pb-take-survey"><a class="ays-btn" href="https://popup-plugin.com/popup-coupon-code-as-a-gift" target="_blank"><?php echo esc_html__("Grab your GIFT", "ays-popup-box"); ?></a></li>
                        ...
                        <li class="modile-ddmenu-md">
                            ...
                            <ul class="ddmenu" data-expanded="false">
                                ...
                                <li class="ays-pb-take-survey"><a class="ays-btn" href="https://popup-plugin.com/popup-coupon-code-as-a-gift" target="_blank"><?php echo esc_html__("Grab your GIFT", "ays-popup-box"); ?></a></li>
