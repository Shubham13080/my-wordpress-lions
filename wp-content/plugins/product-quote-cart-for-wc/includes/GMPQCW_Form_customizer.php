...
$delete_nonce = wp_create_nonce('delete_keyif_action');
?>
  ...
  <table class="widefat">
    ...
    <tr valign="top">
      ...
      <td>
        ...
        if($x>5){
        ?>
        <a href="<?php echo admin_url( 'admin.php?action=delete_keyif&key='.$keylooparrm. '&_wpnonce=' . $delete_nonce);?>" class="button">Delete Field</a>
        <?php
        }
        ?>
      </td>
    ...
    <div class="postbox">
      ...
      <div class="inside">
        <form action="#" method="post" id="wp_job_custom_form">
          ...
          <p class="submit">
            <?php wp_nonce_field('add_custom_field_gmpqcw_action', 'add_custom_field_gmpqcw_nonce'); ?>
